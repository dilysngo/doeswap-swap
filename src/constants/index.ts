...
// Fake data
export const MUTIL_LIQUIDITY = process.env.MUTIL_LIQUIDITY || 'notnull'
export const MUTIL_VOLUME = process.env.REACT_APP_MUTIL_VOLUME || 'notnull'
export const PLUS_TRANSACTION = process.env.REACT_APP_PLUS_TRANSACTION || 'notnull'
...
export const BASE_TOKEN = new Token(ChainId.MAINNET, STAKING_TOKEN_CONTRACT, 6, 'Doeswap', 'Doeswap')
