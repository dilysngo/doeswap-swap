    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              <Text fontSize="14px" style={{ opacity: '0.8' }}>{translatedLabel}</Text>
              {account && (
          ...
          {pair ? (
            ...
            >
              <Aligner>
                ...
                {!disableCurrencySelect && <img style={{ marginLeft: '6px' }} src={DownIcon} width={13} alt="" />}
              </Aligner>
            </CurrencySelect>
          ) : (
            <CurrencySelectValid
            ...
            >
              <Aligner>
                <Text color="#FFFFFF">{TranslateString(1196, 'Select a currency')}</Text>
